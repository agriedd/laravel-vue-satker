...
import SidebarNavTemplate from './SidebarNavTemplate.vue'
export default {
    components: {
        SidebarNavTemplate
    },
    data(){
        return {
            ...
            listbottom: [
                { title: "Organisasi", icon: "mdi-account-group", link: "/admin/organisasi"},
            ...
            listgroup: [
                { title: "Jemaat", icon: "mdi-account-group", active: false, items: [
