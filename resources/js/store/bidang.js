    ...
    actions: {
        get(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('bidang'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        count(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('bidang/count'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async show(context, params){
            ...
            if(id)
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.get(api(`bidang/${id}`), { params: params }).catch(e => reject(e))
                    if(res) resolve(res)
                })
        },
        store(context, data){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.post(api('bidang'), data).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async update(context, data){
            ...
            if(id)
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.post(api(`bidang/${id}`), data).catch(e => reject(e))
                    if(res) resolve(res)
                })
        },
