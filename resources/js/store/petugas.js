    ...
    actions: {
        get(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('petugas'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        count(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('petugas/count'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async show(context, params){
            ...
            if(id)
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.get(api(`petugas/${id}`), { params: params }).catch(e => reject(e))
                    if(res) resolve(res)
                })
        },
        store(context, data){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.post(api('petugas'), data).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async update(context, data){
            ...
            if(id)
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.post(api(`petugas/${id}`), data).catch(e => reject(e))
                    if(res) resolve(res)
                })
        },
