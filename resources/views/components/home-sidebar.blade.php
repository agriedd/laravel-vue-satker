    ...
    <div class="d-flex flex-sm-column">
        ...
        <div data-toggle="tooltip" data-placement="right" title="Bidang">
            <x-home-sidebar-item :url="route('home.bidang')">
                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-journal-bookmark-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div data-toggle="tooltip" data-placement="right" title="Kegiatan">
            <x-home-sidebar-item :url="route('home.kegiatan')">
                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-calendar2-week" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
